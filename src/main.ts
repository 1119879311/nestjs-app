...
import { BadRequestException, UnauthorizedException, ValidationError, ValidationPipe } from '@nestjs/common';
import { HttpExceptionFilter } from './common/filters/http-exception.filter';
import { ResponseInterceptor } from './common/interceptor/response.interceptor';
import { Aes, TimeTranform } from './common/util';
const port = process.env.PORT||3000;

// let res = Aes.encryption('admin',"password_secret")
// console.log('加密',res)
